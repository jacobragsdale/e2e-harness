...
export default defineConfig(
  {
    ignores: ["playwright-report/**", "test-results/**"] // Skip generated Playwright output.
  },
  {
    linterOptions: {
  ...
  },
  {
    ...
    rules: {
      ...
      "playwright/no-force-option": "error", // A forced click hides what a user could not do.
      "playwright/prefer-web-first-assertions": "error", // Retrying assertions instead of one-shot reads.
      "playwright/no-networkidle": "error", // Wait for what the user sees, not for the network.
